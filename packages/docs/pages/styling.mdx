...
This hook receive a config object with two keys:

```json
{
  "ref": "A react component ref, this is the component you want to execute an action when clicked outside it.",
  "callback": "A function to be called when the outside click is done."
}
```
